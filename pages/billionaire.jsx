  ...
  const contentMap = {
    ...
    sneakPeak: (
      <>
        ...
        <p style={{ fontSize: "20px", fontWeight: "bold" }}>You are invited to THE VIP Exclusive Experience</p>
        <p>This quarter past millennium - <strong>BASS BILLIONAIRES</strong>, a one and only once in a lifetime private event <i>guaranteed</i> to elevate your status.</p>
        ...
        <h2>IYKYK we’re full of surprises, but here is a <strong>sneak peak at what’s in store:</strong></h2>
        <ul>
    ...
    ticketInfo: (
      <>
        <p style={{ fontSize: "20px", fontWeight: "bold" }}>Ticket Information</p>


        <p style={{ fontSize: "16px", fontWeight: "bold" }}>Big Ol’ Ballers £189.89</p>
        <p>If you can, please do. Make trickle-down economics work again!</p>

        <p style={{ fontSize: "16px", fontWeight: "bold" }}>Hoi Polloi Bois £169.69</p>
        <p>For the pretty bourgeoisie.</p>

        <p style={{ fontSize: "16px", fontWeight: "bold" }}>Van dwellers & bankruptcy support £139.39</p>
        <p>If you are planning to sleep in your vehicle, or the feds have frozen your liquidities or whatever, we have set aside 15 tickets at this price point.</p>

        <p>Every ticket purchased earns you 20,000 units of the cryptocurrency of your choice: <a href="#buttcoin">ButtCoin</a>, <a href="#monereum">Monereum</a>, or <a href="#fun-gerbils">Fun Gerbils</a>. This is an extremely valuable, time-sensitive offer, worth more than £1,000,000,000 as of today. The cryptocurrency you choose will gain you access to a powerful community of others who chose the same cryptocurrency as you did.</p>

        <p>Get your ticket before they’re gone. We accept cash, credit, check, money-order, gold, and cigarette cartons.</p>

        <p>Cashflow issues? Capitol stuck in the Bermuda Triangle? Too lovedrunk for a prenup and now hemorrhaging alimony? Put your pennies down in three parts.</p>
      </>
    ),
    faq: (
      <>
        ...
        <h2 style={{ fontSize: "20px", fontWeight: "bold" }}>What should I expect? How should I prepare?</h2>
        ...
        <h2 style={{ fontSize: "20px", fontWeight: "bold" }}>Where will I sleep?</h2>
        ...
        <h2 style={{ fontSize: "20px", fontWeight: "bold" }}>What will I eat?</h2>
        ...
        >
          <div className="bg-black bg-opacity-50 min-h-screen p-10">
            ...
            <div className="mt-6 flex flex-col items-center justify-center">
              <a href="https://docs.google.com/forms/d/e/1FAIpQLSdq_ZOMgLzWhQbnHeDlPWsOG9ro1mKdD9NQqEAv_kQZ3mqIDA/viewform?usp=sf_link " target="_blank" rel="noopener noreferrer">
                <Button
                  onClick={() => handleButtonClick("ticketInfo")}
                  className="relative z-0 px-8 sm:px-10 md:px-14 lg:px-16 xl:px-20 h-16 sm:h-20 md:h-24 lg:h-28 xl:h-32 rounded-full font-julius border border-yellow-800 text-yellow-500 bg-transparent transition-all duration-300 hover:bg-red-900 hover:text-neutral-50 text-2xl sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl"
                >
                  Claim your ticket here
                </Button>
              </a>
              <p className="text-xs text-stone-300 mt-2">
                *See our FAQ’s for how ticket prices are distributed.
              </p>
            </div>
